...
export class FlavorCardContainer extends Component {
  ...
  render() {
    ...
    return (
      <fieldset className="flavorCard__container">
        {children}
      </fieldset>
    );
  }
...
export class FlavorCard extends Component {
  ...
  render() {
    const { flavor, price, value, groupName, children, className, ...other } = this.props;
    ...
    return (
      <div>
        ...
        <label htmlFor={value} className="bx--card flavorCard">
          ...
          <ul className="flavorCard__details">
            {children}
          </ul>
...
export class FlavorCardBar extends Component {
  ...
  render() {
    ...
    return (
      <li className="flavorCard__bar" style={computedStyles}><strong>{count}</strong> {unit}</li>
    );
  }
}
